...
export var MyDatePicker = (function() {
    ...
    MyDatePicker.prototype.todayClicked = function() {
        ...
        this.selectDate({ day: today.day, month: today.month, year: today.year + 543 });
    ...
    MyDatePicker.prototype.generateCalendar = function(m, y) {
        this.dates.length = 0;
        var today = this.getToday();
        var monthStart = this.monthStartIdx(y - 543, m);
        var dInThisM = this.daysInMonth(m, y - 543);
        var dInPrevM = this.daysInPrevMonth(m, y - 543);
        var dayNbr = 1;
